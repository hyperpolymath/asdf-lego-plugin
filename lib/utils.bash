...
get_download_url() {
  ...
  local asset_name
  asset_name="$(echo 'lego_{version}_{os}_{arch}.tar.gz' | sed "s/{version}/$version/g" | sed "s/{os}/$os/g" | sed "s/{arch}/$arch/g")"
  ...
  asset_name="$(echo 'lego_{version}_{os}_{arch}.tar.gz' | sed "s/{version}/$version/g" | sed "s/{os}/$os_lower/g" | sed "s/{arch}/$arch/g")"
